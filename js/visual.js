...
var buttons = buttonDiv.selectAll(".updateButton")
  ...
  .on("click", function(d, i) {
    ...
    if (dataSource==0){
	        if (rankingorder){
	            $.post("insertaraccion.php",{idSesion:sesionId,accion:'7',idAsociado:'NULL',queryGroup:marcador,tipoAccion:'visual'});
	        }
	        else{
	            $.post("insertaraccion.php",{idSesion:sesionId,accion:'8',idAsociado:'NULL',queryGroup:marcador,tipoAccion:'visual'});
	        }
	    }
	    if (dataSource==1){
	        if (dateOrder){
	            $.post("insertaraccion.php",{idSesion:sesionId,accion:'9',idAsociado:'NULL',queryGroup:marcador,tipoAccion:'visual'});
	        }
	        else{
	            $.post("insertaraccion.php",{idSesion:sesionId,accion:'10',idAsociado:'NULL',queryGroup:marcador,tipoAccion:'visual'});
	        }
	    }
	    if (dataSource==2){
	        if (scoreOrder){
	            $.post("insertaraccion.php",{idSesion:sesionId,accion:'11',idAsociado:'NULL',queryGroup:marcador,tipoAccion:'visual'});
	        }
	        else{
	            $.post("insertaraccion.php",{idSesion:sesionId,accion:'12',idAsociado:'NULL',queryGroup:marcador,tipoAccion:'visual'});
	        }
	    }
	    if (dataSource==3){
	        if (reputationOrder){
	            $.post("insertaraccion.php",{idSesion:sesionId,accion:'13',idAsociado:'NULL',queryGroup:marcador,tipoAccion:'visual'});
	        }
	        else{
	            $.post("insertaraccion.php",{idSesion:sesionId,accion:'14',idAsociado:'NULL',queryGroup:marcador,tipoAccion:'visual'});
	        }
	    }    
  });
...
function mostrarPagina(d){
  ...
  if(!d.children){
    ...
    document.getElementById('page-container').src = d.url_local;
        ...
        document.getElementById("i4-reputation").innerHTML = d.repu_normalizada;
        ...
        var xyz=idActual;
        $.post("insertaraccion.php",{idSesion:sesionId,accion:'0',idAsociado:xyz,queryGroup:marcador,tipoAccion:'visual'});
...
function union(datos){
  ...
  if (datos==flora) {
    if (marcador==0||marcador==2||marcador==3||marcador==4){
      $.post("insertaraccion.php",{idSesion:sesionId,accion:'3',idAsociado:null,queryGroup:marcador,tipoAccion:'visual'});
    }
    marcador=1;
    tooltip.style("visibility", "hidden");
    document.getElementById("c1").style.background="green";
  ...
  if (datos==superficie) {
    if (marcador==0||marcador==1||marcador==3||marcador==4){
      $.post("insertaraccion.php",{idSesion:sesionId,accion:'4',idAsociado:null,queryGroup:marcador,tipoAccion:'visual'});
    }
    marcador=2;
    tooltip.style("visibility", "hidden");
  ...
  if (datos==maniobras) {
    if (marcador==0||marcador==1||marcador==2||marcador==4){
      $.post("insertaraccion.php",{idSesion:sesionId,accion:'5',idAsociado:null,queryGroup:marcador,tipoAccion:'visual'});
    }
    marcador=3;
    tooltip.style("visibility", "hidden");
    document.getElementById("c1").style.background="#D9D9D9";
  ...
  if (datos==responsabilidades) {
    if (marcador==0||marcador==1||marcador==2||marcador==3){
      $.post("insertaraccion.php",{idSesion:sesionId,accion:'6',idAsociado:null,queryGroup:marcador,tipoAccion:'visual'});
    }
    marcador=4;
    tooltip.style("visibility", "hidden");
    document.getElementById("c1").style.background="#D9D9D9";
...
function guardarPagina(){
  ...
  if (index==-1) {
    ...
    $.post("insertaraccion.php",{idSesion:sesionId,accion:'15',idAsociado:idActual,queryGroup:marcador,tipoAccion:'visual'});
  }
    ...
    //updateVis();
    //actualizaPuntos(idActual);
    $.post("insertaraccion.php",{idSesion:sesionId,accion:'21',idAsociado:idActual,queryGroup:marcador,tipoAccion:'visual'});
  }
...
function guardarPagina2(){
  ...
  if (index2==-1) {
    ...
    //updateVis();
    //actualizaPuntos(idActual);
    $.post("insertaraccion.php",{idSesion:sesionId,accion:'16',idAsociado:idActual,queryGroup:marcador,tipoAccion:'visual'});
  }
  else{
    ...
    //updateVis();
    //actualizaPuntos(idActual);
    $.post("insertaraccion.php",{idSesion:sesionId,accion:'22',idAsociado:idActual,queryGroup:marcador,tipoAccion:'visual'});
  }
...
function guardarPagina3(){
  ...
  if (index3==-1) {
    ...
    //updateVis();
    //actualizaPuntos(idActual);
    $.post("insertaraccion.php",{idSesion:sesionId,accion:'17',idAsociado:idActual,queryGroup:marcador,tipoAccion:'visual'});
  }
  else{
    ...
    //updateVis();
    //actualizaPuntos(idActual);
    $.post("insertaraccion.php",{idSesion:sesionId,accion:'23',idAsociado:idActual,queryGroup:marcador,tipoAccion:'visual'});
  }
}
...
function guardarPagina4(){
  ...
  if (index4==-1) {
    ...
    //updateVis();
    //actualizaPuntos(idActual);
    $.post("insertaraccion.php",{idSesion:sesionId,accion:'18',idAsociado:idActual,queryGroup:marcador,tipoAccion:'visual'});
  }
  else{
    ...
    //actualizaPuntos(idActual);
    //updateVis();
    $.post("insertaraccion.php",{idSesion:sesionId,accion:'24',idAsociado:idActual,queryGroup:marcador,tipoAccion:'visual'});
  }
}
...
function divLogin(){ 
   ...
   clic = clic + 1;
   $.post("insertaraccion.php",{idSesion:sesionId,accion:'2',idAsociado:idActual,queryGroup:marcador,tipoAccion:'visual'});
   } else{
       document.getElementById("page-container").style.height = "919px";
       document.getElementById("botonMostrarOcultar").value="Ocultar Página";
    clic = 1;
    $.post("insertaraccion.php",{idSesion:sesionId,accion:'1',idAsociado:idActual,queryGroup:marcador,tipoAccion:'visual'});
   }   
}
...
"children": 
[
{ "id": "1100","repu": 1,"fecha": 74,"url": "http://ecoguiaemporda.com/ecodenuncia-a-ecoguiaemporda/67-denuncies-i-opinions/1939-derrame-de-petroleo-sin-precedentes-en-el-rio-guarapiche-de-maturin-estado-monagas-venezuela.html","name": "Derrame de petróleo sin precedentes en el Río Guarapiche ...","snippet": "Después del derrame de petróleo acontecido en el Golfo de México, en el  ...  de su flora y fauna, y de la armoniosa relación de los humanos y el resto de la  ...","ranking": 97,"size": 1.020408163,"rscore": 7.20787,"reputation": 0,"repu_normalizada": 0,"date": "29-06-2012","colour": 27,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/ecoguiaemporda.com/ecodenuncia-a-ecoguiaemporda/67-denuncies-i-opinions/1939-derrame-de-petroleo-sin-precedentes-en-el-rio-guarapiche-de-maturin-estado-monagas-venezuela.html"}, 
{ "id": "1101","repu": 2,"fecha": 39,"url": "http://www.marketingworld.tv/derrame-de-petroleo-amenaza-vida-marina/","name": "Derrame De Petróleo Amenaza Vida Marina - marketing world","snippet": "El derrame de petróleo en el Golfo de México es considerado el más  ...  Muchos de los animales han ingerido sustancias tóxicas que son  ...","ranking": 95,"size": 1.041666667,"rscore": 94.755615,"reputation": 0,"repu_normalizada": 0,"date": "22-06-2010","colour": 3,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.marketingworld.tv/derrame-de-petroleo-amenaza-vida-marina/index.html"}, 
{ "id": "1102","repu": 65,"fecha": 85,"url": "http://noticias-ambientales-internacionales.blogspot.com/2014/04/china-castiga-con-carcel-el-consumo-de.html","name": "China castiga con carcel el consumo de animales exóticos","snippet": "China: Hasta 10 años de cárcel para quienes coman animales exóticos  ....  Caribe · Caso Derrame de Petróleo de BP en el Golfo de México  ...","ranking": 98,"size": 1.01010101,"rscore": 6.17891,"reputation": 1,"repu_normalizada": 0,"date": "25-04-2014","colour": 49,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/noticias-ambientales-internacionales.blogspot.cl/2014/04/china-castiga-con-carcel-el-consumo-de.html"}, 
{ "id": "1103","repu": 3,"fecha": 23,"url": "http://fotografiainteligente2j.blogspot.com/2010/05/mueren-189-animales-por-derrame-de.html","name": "Mueren 189 animales por derrame de crudo en el Golfo de ...","snippet": "Mueren 189 animales por derrame de crudo en el Golfo de México  ...  explicó que no se han detectado restos de petróleo en las tortugas  ...","ranking": 94,"size": 1.052631579,"rscore": 3.892105,"reputation": 0,"repu_normalizada": 0,"date": "19-05-2010","colour": 2,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/fotografiainteligente2j.blogspot.cl/2010/05/mueren-189-animales-por-derrame-de.html"}, 
{ "id": "1104","repu": 4,"fecha": 27,"url": "http://bloglemu.blogspot.com/2010/05/derrame-de-petroleo-en-el-golfo-de_21.html","name": "Derrame de petróleo en el golfo de México: la marea negra ...","snippet": "Derrame de petróleo en el golfo de México: la marea negra ha llegado a las costas  ...  Fotografía | Ryan Hagerty U.S. Fish and Wildlife Service","ranking": 93,"size": 1.063829787,"rscore": 8.006,"reputation": 0,"repu_normalizada": 0,"date": "21-05-2010","colour": 2,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/bloglemu.blogspot.cl/2010/05/derrame-de-petroleo-en-el-golfo-de_21.html"}, 
{ "id": "1105","repu": 5,"fecha": 78,"url": "http://suite101.net/article/situacion-actual-del-golfo-de-mexico-tras-el-derrame-de-petroleo-a42128","name": "Situación actual del Golfo de México tras el derrame de ...","snippet": "Situación actual del Golfo de México tras el derrame de petróleo  ...  fotografías de animales que habitan en el fondo marino asfixiados por el petróleo, evidencia  ...","ranking": 91,"size": 1.086956522,"rscore": 8.78551,"reputation": 0,"repu_normalizada": 0,"date": "03-07-2013","colour": 40,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/suite101.net/article/situacion-actual-del-golfo-de-mexico-tras-el-derrame-de-petroleo-a42128.html"}, 
{ "id": "1106","repu": 6,"fecha": 75,"url": "https://www.sadm.gob.mx/PortalSadm/jsp/prensa.jsp?id=406","name": "Derrames petroleros: Fuga irreparable - Servicios de Agua y ...","snippet": "La marea negra afecta el agua, los animales, las plantas y los seres humanos,  ...  El derrame de petróleo desencadena una serie de sucesos que pueden llegar a  ...  Este pozo petrolero ubicado en el Golfo de México a 965 kilómetros al sur de  ...","ranking": 90,"size": 1.098901099,"rscore": 2.604034,"reputation": 0,"repu_normalizada": 0,"date": "02-11-2012","colour": 65,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.sadm.gob.mx/PortalSadm/jsp/prensa2455.html"}, 
{ "id": "1107","repu": 72,"fecha": 92,"url": "http://noticias-ambientales-internacionales.blogspot.com/2014/12/mexico-prohibe-animales-silvestres-en.html","name": "México prohíbe animales silvestres en los circos - Noticias ...","snippet": "El Congreso prohíbe el uso de animales silvestres en los circos  ....  de Ozono · Caribe · Caso Derrame de Petróleo de BP en el Golfo de México  ...","ranking": 99,"size": 1,"rscore": 90.638718,"reputation": 2,"repu_normalizada": 0,"date": "16-12-2014","colour": 65,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/noticias-ambientales-internacionales.blogspot.cl/2014/12/mexico-prohibe-animales-silvestres-en.html"}, 
{ "id": "1108","repu": 7,"fecha": 18,"url": "http://spanish.china.org.cn/science/txt/2010-05/14/content_20042321.htm","name": "La fuga de petróleo en el golfo de México amenaza la vida ...","snippet": "La fuga de petróleo en el golfo de México amenaza la vida del cachalote y  ...  El accidente amenaza la subsistencia de los siguientes diez animales:  ...  que han ingerido petróleo derramado, ellos mismos tendrán problemas.","ranking": 88,"size": 1.123595506,"rscore": 6.232994,"reputation": 0,"repu_normalizada": 0,"date": "14-05-2010","colour": 2,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/spanish.china.org.cn/science/txt/2010-05/14/content_20042321.html"}, 
{ "id": "1109","repu": 8,"fecha": 64,"url": "http://amadosanimales-estrellaanamaria.blogspot.com/2011/05/muerte-de-delfines-en-golfo-de-mexico.html","name": "Muerte de delfines en Golfo de México sería causada por ...","snippet": "ESTRELLA ANA MARIA - AMADOS ANIMALES  ...  Muerte de delfines en Golfo de México sería causada por derrame de crudo.  ...  el Golfo de México, habrían sufrido los efectos del gigantesco derrame de petróleo ocurrido en  ...","ranking": 87,"size": 1.136363636,"rscore": 2.4821,"reputation": 0,"repu_normalizada": 0,"date": "28-05-2011","colour": 14,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/amadosanimales-estrellaanamaria.blogspot.cl/2011/05/muerte-de-delfines-en-golfo-de-mexico.html"}, 
{ "id": "1110","repu": 9,"fecha": 5,"url": "http://es.bab.la/diccionario/ingles-espanol/land-animal","name": "'land animal' en español - Bab.la","snippet": "Hasta ahora, se han derramado en el Golfo de México cientos de millones de litros de petróleo crudo causando pérdidas masivas de flora marina, así como de  ...","ranking": 89,"size": 1.111111111,"rscore": 15.04755,"reputation": 0,"repu_normalizada": 0,"date": "22-04-2008","colour": 0,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/es.bab.la/diccionario/ingles-espanol/land-animal.html"}, 
{ "id": "1111","repu": 10,"fecha": 66,"url": "http://polucionupc2011i.blogspot.com/2011/06/caso-british-petroleum-derrame-en-el.html","name": "Caso British Petroleum - Derrame en el Golfo de México","snippet": "Caso British Petroleum - Derrame en el Golfo de México: Un dilema Supra  ...  analizará el caso del derrame de petróleo en el Golfo de México por  ...  Este derrame incontrolable afectó a comunidades, negocios, animales y el  ...","ranking": 85,"size": 1.162790698,"rscore": 15.38286,"reputation": 0,"repu_normalizada": 0,"date": "21-06-2011","colour": 15,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/polucionupc2011i.blogspot.cl/2011/06/caso-british-petroleum-derrame-en-el.html"}, 
{ "id": "1112","repu": 11,"fecha": 65,"url": "http://polucionupc2011i.blogspot.com/2011/05/caso-british-petroleum-derrame-de.html","name": "Polución: CASO BRITISH PETROLEUM - DERRAME DE ...","snippet": "...  DERRAME DE PETR??LEO EN EL GOLFO DE M??XICO  ...  de extinción) según el Departamento de Fauna, Flora y Vida Marina de Luisiana.","ranking": 86,"size": 1.149425287,"rscore": 10.71085,"reputation": 0,"repu_normalizada": 0,"date": "30-05-2011","colour": 14,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/polucionupc2011i.blogspot.cl/2011/05/caso-british-petroleum-derrame-de.html"}, 
{ "id": "1113","repu": 12,"fecha": 21,"url": "http://sustentator.com/blog-es/blog/2010/05/17/derrame-de-petroleo-en-el-golfo-de-mexico/","name": "Derrame de petroleo en el Golfo de Mexico: la situacion actual","snippet": "Derrame de petroleo en el Golfo de Mexico: la situacion actual  ...  Lamentablemente, todo indica que el derrame de petróleo no se puede  ....  de origen animal https://t.co/iDcIpoqWXm #alimentación #vegan @sustentator","ranking": 82,"size": 1.204819277,"rscore": 12.67354,"reputation": 0,"repu_normalizada": 0,"date": "17-05-2010","colour": 2,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/sustentator.com/blog-es/blog/2010/05/17/derrame-de-petroleo-en-el-golfo-de-mexico/index.html"}, 
{ "id": "1114","repu": 13,"fecha": 30,"url": "http://www.juventudrebelde.cu/internacionales/2010-05-26/derrame-de-petroleo-es-ya-mayor-desastre-ecologico-/","name": "Derrame de petróleo es ya mayor desastre ecológico ...","snippet": "_ El derrame de petróleo en el Golfo de México que afecta a las  ...  el momento han aparecido 316 ejemplares de animales sin vida en los  ...","ranking": 84,"size": 1.176470588,"rscore": 16.663185,"reputation": 0,"repu_normalizada": 0,"date": "26-05-2010","colour": 2,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.juventudrebelde.cu/internacionales/2010-05-26/derrame-de-petroleo-es-ya-mayor-desastre-ecologico-/index.html"}, 
{ "id": "1115","repu": 14,"fecha": 100,"url": "http://www.urgente24.com/197703-otra-gigantesca-mancha-de-crudo-en-el-golfo-de-mexico","name": "Otra gigantesca mancha de crudo en el Golfo de México ...","snippet": "La Royal Dutch Shell se desentendió de la responsabilidad del derrame aunque tiene  ...  Mancha de petróleo en el Golfo de México (2010)  ....  de Buenos Aires, Argentina, el 15 de enero de 1999, contaminando el agua, la flora y la fauna.","ranking": 81,"size": 1.219512195,"rscore": 12.811424,"reputation": 0,"repu_normalizada": 0,"date": "26-12-2015","colour": 65,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.urgente24.com/197703-otra-gigantesca-mancha-de-crudo-en-el-golfo-de-mexico.html"}, 
{ "id": "1116","repu": 15,"fecha": 42,"url": "http://animalnaturaleza.blogspot.com/2010/07/como-se-limpian-los-animales-del-golfo.html","name": "Mundo animal: Como se limpian los animales del Golfo","snippet": "No se si todos somos conscientes de la catástrofe que produce este derrame de petróleo en el Golfo de México. En este año dedicado a la  ...","ranking": 79,"size": 1.25,"rscore": 10.47226,"reputation": 0,"repu_normalizada": 0,"date": "04-07-2010","colour": 4,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/animalnaturaleza.blogspot.cl/2010/07/como-se-limpian-los-animales-del-golfo.html"}, 
{ "id": "1117","repu": 16,"fecha": 6,"url": "http://www.lanacion.com.ar/1259760-eeuu-alerta-por-un-derrame-de-crudo","name": "EE.UU.: alerta por un derrame de crudo - La Nación","snippet": "alerta por un derrame de crudo | Una marea negra avanza hacia la costa de  ...  de crudo de su historia en el golfo de México, donde una mancha de petróleo del  ...  amenazando la vida de cientos de especies de flora y fauna.","ranking": 76,"size": 1.298701299,"rscore": 18.18731,"reputation": 0,"repu_normalizada": 0,"date": "30-04-2010","colour": 1,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.lanacion.com.ar/1259760-eeuu-alerta-por-un-derrame-de-crudo.html"}, 
{ "id": "1118","repu": 17,"fecha": 52,"url": "http://www.ebah.com.br/content/ABAAABcd4AC/tcc-manoel","name": "TCC Manoel - DERRAME DE PETROLEO EM AMBIENTE ...","snippet": "Figura 6 - Ave marinha coberta pelo petróleo Golfo do México Fonte estadão (2010)  ...  Além da ameaça da fauna e a flora marinha, também afeta o ser humano,  ...","ranking": 72,"size": 1.369863014,"rscore": 15.761826,"reputation": 0,"repu_normalizada": 0,"date": "01-09-2010","colour": 6,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.ebah.com.br/content/ABAAABcd4AC/tcc-manoel.html"}, 
{ "id": "1119","repu": 18,"fecha": 40,"url": "http://www.teleaire.com/derrame-de-petroleo-en-el-golfo-de-mexico-a-71-dias-del-desastre/","name": "Derrame de petróleo en el Golfo de México - Teleaire.com","snippet": "El derrame de petróleo ocurrido el pasado 20 de abril en el Golfo mexicano se  ...  Son incalculables las pérdidas en flora y fauna marítima: el  ...","ranking": 77,"size": 1.282051282,"rscore": 13.64046,"reputation": 0,"repu_normalizada": 0,"date": "01-07-2010","colour": 4,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.teleaire.com/derrame-de-petroleo-en-el-golfo-de-mexico-a-71-dias-del-desastre/index.html"}, 
{ "id": "1120","repu": 19,"fecha": 2,"url": "http://html.rincondelvago.com/efectos-de-los-derrames-de-crudos-en-aguas-marinas_metodos-de-prevencion-y-plan-de-contingencia.html","name": "Efectos de los derrames de crudos en aguas marinas ...","snippet": "Para definir el comportamiento de un derrame de petróleo en el mar, se puede  ....  de numerosas especies de animales entre de las cuales se encuentran aves,  ...","ranking": 70,"size": 1.408450704,"rscore": 29.57046,"reputation": 0,"repu_normalizada": 0,"date": "26-04-2004","colour": 0,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/html.rincondelvago.com/efectos-de-los-derrames-de-crudos-en-aguas-marinas_metodos-de-prevencion-y-plan-de-contingencia.html"}, 
{ "id": "1121","repu": 20,"fecha": 45,"url": "http://abrazode4patas.blogspot.com/2010/07/contener-derrame-de-petroleo-en-el.html","name": "Contener derrame de petróleo en el Golfo de México es ...","snippet": "Contener derrame de petróleo en el Golfo de México es más difícil que ir a la Luna. Foto: Reuters. Son cientos los animales, como los  ...","ranking": 78,"size": 1.265822785,"rscore": 23.997284,"reputation": 0,"repu_normalizada": 0,"date": "06-07-2010","colour": 4,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/abrazode4patas.blogspot.cl/2010/07/contener-derrame-de-petroleo-en-el.html"}, 
{ "id": "1122","repu": 21,"fecha": 83,"url": "http://www.noticiasambientales.com.ar/index.php?modulo=13&id=2521","name": "Golfo de México: peces sufren afecciones cardíacas por el ...","snippet": "Golfo de México: peces sufren afecciones cardíacas por el derrame de  ...  dejó el derrame petrolero de la plataforma operada por British Petroleum en 2010,  ...  conducir a paros cardíacos y la muerte repentina de los animales.","ranking": 68,"size": 1.449275362,"rscore": 29.92099,"reputation": 0,"repu_normalizada": 0,"date": "19-02-2014","colour": 47,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.noticiasambientales.com.ar/index64f2.html"}, 
{ "id": "1123","repu": 22,"fecha": 16,"url": "http://www.futuroverderd.com/desastre-ambiental-amenaza-golfo-de-mexico/","name": "DESASTRE AMBIENTAL AMENAZA GOLFO DE MEXICO ...","snippet": "DESASTRE AMBIENTAL AMENAZA GOLFO DE MEXICO  ...  para contener un enorme derrame de petróleo en el Golfo de México.  ...  que además de ser reservas de fauna y flora silvestres son destinos turísticos y de pesca  ...","ranking": 69,"size": 1.428571429,"rscore": 24.52779,"reputation": 0,"repu_normalizada": 0,"date": "11-05-2010","colour": 2,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.futuroverderd.com/desastre-ambiental-amenaza-golfo-de-mexico/index.html"}, 
{ "id": "1124","repu": 23,"fecha": 68,"url": "http://lashojasverdes.com/tag/animales-muertos-por-petroleo/","name": "animales muertos por petroleo | Las Hojas Verdes","snippet": "Posts about animales muertos por petroleo written by lashojasverdes.  ...  más grave ocurrido en el Golfo de México, debido al accidente ocurrido el 20 de abril de 2010,  ...  El derrame produjo la muerte a más de 2.600 animales entre los que se  ...","ranking": 64,"size": 1.538461538,"rscore": 23.99917,"reputation": 0,"repu_normalizada": 0,"date": "15-09-2011","colour": 65,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/lashojasverdes.com/tag/animales-muertos-por-petroleo/index.html"}, 
{ "id": "1125","repu": 24,"fecha": 67,"url": "http://www.dw.com/es/derrame-petrolero-en-el-mar-del-norte-el-m%C3%A1s-grave-de-la-d%C3%A9cada/a-15318901","name": "Derrame petrolero en el Mar del Norte - Deutsche Welle","snippet": "La petrolera neerlandesa Royal Dutch Shell informó que el derrame de crudo  ...  en el Golfo de México en 2010 ???cuando un accidente en la plataforma  ...  El ???Rey de los animales??? está en peligro de extinción y sólo podrá  ...","ranking": 71,"size": 1.388888889,"rscore": 20.1546,"reputation": 0,"repu_normalizada": 0,"date": "16-08-2011","colour": 65,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.dw.com/es/derrame-petrolero-en-el-mar-del-norte-el-m%C3%A1s-grave-de-la-d%C3%A9cada/a-15318901.html"}, 
{ "id": "1126","repu": 25,"fecha": 47,"url": "http://www.vanguardia.com/historico/69879-bonnie-lleva-mas-petroleo-al-golfo-y-afectara-a-animales","name": "Bonnie lleva más petróleo al Golfo y afectará a animales ...","snippet": "El ciclón se desplazará sobre el derrame de crudo que se extiende sobre buena parte del Golfo de México desde hoy al medio día y en la noche se aproximará  ...","ranking": 67,"size": 1.470588235,"rscore": 27.17179,"reputation": 0,"repu_normalizada": 0,"date": "24-07-2010","colour": 4,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.vanguardia.com/historico/69879-bonnie-lleva-mas-petroleo-al-golfo-y-afectara-a-animales.html"}, 
{ "id": "1127","repu": 26,"fecha": 11,"url": "http://www.conscienciaolocura.net/category/noticias/","name": "Consciencia o Locura » Noticias","snippet": "Escrito por admin Publicado en Conciencia Ecológica, Cuida a los animales,  ....  Este derrame de petróleo en el Golfo de México, sin duda, representa un  ...","ranking": 66,"size": 1.492537313,"rscore": 27.93766,"reputation": 0,"repu_normalizada": 0,"date": "06-05-2010","colour": 2,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.conscienciaolocura.net/category/noticias/index.html"}, 
{ "id": "1128","repu": 27,"fecha": 57,"url": "http://www.lacomunidadpetrolera.com/sectores/energia-sectores/impacto-ambiental-que-origina-el-petroleo-y-los-entes-que-intervienen-en-el-momento-de-una-afectacion-de-este-tipo/","name": "Impacto ambiental que origina el petróleo y los entes que ...","snippet": "Afecta en forma directa al suelo, agua, aire, y a la fauna y la flora.  ...  Por otro lado los derrames de petróleo y los desechos producen una alteración del sustrato original  ...  ZONA 2 (Golfo de Venezuela y península de Paraguana).  ...  Ecuador · España · Estados Unidos · México · Perú · Venezuela · Resto de América · Mundo.","ranking": 57,"size": 1.724137931,"rscore": 22.88439,"reputation": 0,"repu_normalizada": 0,"date": "11-11-2010","colour": 8,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.lacomunidadpetrolera.com/sectores/energia-sectores/impacto-ambiental-que-origina-el-petroleo-y-los-entes-que-intervienen-en-el-momento-de-una-afectacion-de-este-tipo/index.html"}, 
{ "id": "1129","repu": 28,"fecha": 31,"url": "http://cordis.europa.eu/news/rcn/32143_es.html","name": "Comisión Europea : CORDIS : Noticias y Eventos : Un ...","snippet": "...  los efectos en animales de la corticosterona, una hormona segregada  ...  por el enorme derrame de petróleo ocurrido en el Golfo de México.","ranking": 60,"size": 1.639344262,"rscore": 20.283875,"reputation": 0,"repu_normalizada": 0,"date": "27-05-2010","colour": 2,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/cordis.europa.eu/news/rcn/32143_es.html"}, 
{ "id": "1130","repu": 29,"fecha": 24,"url": "http://blog.fundacionmontemadrid.es/medio-ambiente/los-derrames-de-petroleo-mas-catastroficos-de-la-historia/","name": "Los derrames de petróleo más catastróficos de la historia ...","snippet": "El último derrame de petróleo ocurrido en la zona del Golfo de México  ...  daños en la flora y fauna siguen teniendo repercusión en estos días.","ranking": 56,"size": 1.754385965,"rscore": 30.162025,"reputation": 0,"repu_normalizada": 0,"date": "19-05-2010","colour": 2,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/blog.fundacionmontemadrid.es/medio-ambiente/los-derrames-de-petroleo-mas-catastroficos-de-la-historia/index.html"}, 
{ "id": "1131","repu": 30,"fecha": 14,"url": "http://planetabeta.com/derrame-petrolero-golfo-mexico-afecta-numerosos-especies-animales","name": "Derrame petrolero en el Golfo de México afecta a ...","snippet": "Derrame petrolero en el Golfo de México afecta a numerosos especies de animales ... Despertar del fotógrafo Jane Fulton Alt muestra lo que el derrame de petróleo BP ha hecho a las playas verdes a lo largo del Golfo de ...","ranking": 59,"size": 1.666666667,"rscore": 33.14258,"reputation": 0,"repu_normalizada": 0,"date": "07-05-2010","colour": 2,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/planetabeta.com/derrame-petrolero-golfo-mexico-afecta-numerosos-especies-animales.html"}, 
{ "id": "1132","repu": 31,"fecha": 25,"url": "http://www.informador.com.mx/tecnologia/2010/202955/6/derrame-de-petroleo-pone-en-peligro-muchas-especies.htm","name": "Derrame de petróleo pone en peligro muchas especies :: El ...","snippet": "Derrame de petróleo pone en peligro muchas especies  ...  vertido de petróleo en el Golfo de México puede acabar 'colapsando' algunas especies.  ...  mayoría son devoradas por otros animales, se hunden o se descomponen.","ranking": 58,"size": 1.694915254,"rscore": 34.80887,"reputation": 0,"repu_normalizada": 0,"date": "20-05-2010","colour": 2,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.informador.com.mx/tecnologia/2010/202955/6/derrame-de-petroleo-pone-en-peligro-muchas-especies.html"}, 
{ "id": "1133","repu": 32,"fecha": 51,"url": "http://www.lavoz.com.ar/ciudadanos/ambiente/obama-se-bano-en-el-golfo-de-mexico-para-promover-el-turismo","name": "Obama se bañó en el golfo de México para promover el ...","snippet": "Luego del derrame de petróleo el presidente de Estados Unidos quiere  ...  del Golfo de México, en la fauna, la flora tanto marina como costera,  ...","ranking": 48,"size": 2.040816327,"rscore": 37.721954,"reputation": 0,"repu_normalizada": 0,"date": "15-08-2010","colour": 5,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.lavoz.com.ar/ciudadanos/ambiente/obama-se-bano-en-el-golfo-de-mexico-para-promover-el-turismo.html"}, 
{ "id": "1134","repu": 33,"fecha": 84,"url": "http://www.cromo.com.uy/el-ecosistema-marino-del-golfo-mexico-no-se-ha-recuperado-n566660","name": "El ecosistema marino del Golfo de México no se ha ... - Cromo","snippet": "El ecosistema marino del Golfo de México no se ha recuperado  ...  la explosión de la plataforma petrolera siguen afectando a delfines, tortugas y peces  ...  el derrame de 4,9 millones de barriles de crudo en las aguas del Golfo de México.  ...  de la restauración de una especie animal en el Golfo de México.","ranking": 51,"size": 1.923076923,"rscore": 32.62451,"reputation": 0,"repu_normalizada": 0,"date": "11-04-2014","colour": 49,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.cromo.com.uy/el-ecosistema-marino-del-golfo-mexico-no-se-ha-recuperado-n566660.html"}, 
{ "id": "1135","repu": 34,"fecha": 3,"url": "http://www.scielo.org.ve/scielo.php?pid=S0378-18442004000600006&script=sci_arttext","name": "Interciencia - Impacto ecológico de la industria petrolera en ...","snippet": "La Sonda de Campeche se localiza en la parte sur del Golfo de México, entre dos  ....  Cuando se presenta la eventualidad de un derrame, el tipo de petróleo y su  ....  y los últimos presentan diversos efectos sobre flora y fauna (NOAA, 1992b","ranking": 50,"size": 1.960784314,"rscore": 33.13031,"reputation": 0,"repu_normalizada": 0,"date": "06-06-2004","colour": 0,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.scielo.org.ve/scielof05c.html"}, 
{ "id": "1136","repu": 35,"fecha": 12,"url": "http://noticias.emisorasunidas.com/noticias/salud/usan-cabello-humano-y-animal-para-limpiar-derrame-de-petroleo","name": "Usan cabello humano y animal para limpiar derrame de ...","snippet": "Usan cabello humano y animal para limpiar derrame de petróleo  ...  de pelo animal y humano y fibras de nailon para limpiar el Golfo de México  ...","ranking": 43,"size": 2.272727273,"rscore": 35.86162,"reputation": 0,"repu_normalizada": 0,"date": "06-05-2010","colour": 2,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/noticias.emisorasunidas.com/noticias/salud/usan-cabello-humano-y-animal-para-limpiar-derrame-de-petroleo.html"}, 
{ "id": "1137","repu": 36,"fecha": 60,"url": "http://entrerayas.com/2012/03/contaminacion-ambiental-de-la-industria-petrolera/","name": "Contaminación ambiental de la industria petrolera - Entre ...","snippet": "...  de la industria petrolera fue el derrame de crudo en el Golfo de México  ...  Los animales y ecosistemas mas afectados por los derrames de  ...","ranking": 49,"size": 2,"rscore": 36.19946,"reputation": 0,"repu_normalizada": 0,"date": "06-03-2011","colour": 12,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/entrerayas.com/2012/03/contaminacion-ambiental-de-la-industria-petrolera/index.html"}, 
{ "id": "1138","repu": 37,"fecha": 1,"url": "http://www.ambientum.com/revista/2003_01/FCTVRTD.htm","name": "Efectos ecológicos del vertido de petróleo - Ambientum","snippet": "El vertido del petrolero Prestige nos hace preguntarnos sobre los efectos reales  ...  En algunos accidentes se han llegado a derramar más de 400.000 toneladas, como en la rotura de una plataforma marina en el Golfo de México, en 1979.  ...  causar extraordinarias mortandades en pájaros, focas y todo tipo de fauna y flora.","ranking": 47,"size": 2.083333333,"rscore": 35.40999,"reputation": 0,"repu_normalizada": 0,"date": "01-12-2003","colour": 0,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.ambientum.com/revista/2003_01/FCTVRTD.html"}, 
{ "id": "1139","repu": 38,"fecha": 72,"url": "http://pobrezaambiente.typepad.com/blog/2012/03/el-petroleo-derramado-en-el-accidente-del-golfo-de-mexico-entro-a-la-cadena-alimenticia-del-ecosiste.html","name": "El petroleo derramado en el accidente del Golfo de Mexico ...","snippet": "El petroleo derramado en el accidente del Golfo de Mexico penetró la  ...  El zooplancton son pequeños animales a la deriva presentes en el  ...","ranking": 42,"size": 2.325581395,"rscore": 39.44748,"reputation": 0,"repu_normalizada": 0,"date": "21-03-2012","colour": 24,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/pobrezaambiente.typepad.com/blog/2012/03/el-petroleo-derramado-en-el-accidente-del-golfo-de-mexico-entro-a-la-cadena-alimenticia-del-ecosiste.html"}, 
{ "id": "1140","repu": 39,"fecha": 22,"url": "http://www.emol.com/noticias/internacional/2010/05/18/413846/casi-200-animales-han-sido-hallados-muertos-desde-inicio-de-derrame-de-crudo-en-eeuu.html","name": "Casi 200 animales han sido hallados muertos desde inicio ...","snippet": "Aunque no se han encontrado restos de petróleo en las tortugas, éstas  ...  hoy que desde el comienzo del derrame de crudo en el Golfo de México han  ...  de la Fauna y Flora Contaminados por Derrames de la Universidad de  ...","ranking": 46,"size": 2.127659574,"rscore": 46.654976,"reputation": 0,"repu_normalizada": 0,"date": "18-05-2010","colour": 2,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.emol.com/noticias/internacional/2010/05/18/413846/casi-200-animales-han-sido-hallados-muertos-desde-inicio-de-derrame-de-crudo-en-eeuu.html"}, 
{ "id": "1141","repu": 80,"fecha": 26,"url": "http://www.elmundo.es/america/2010/05/20/estados_unidos/1274316306.html","name": "En Florida nadie tiene la más mínima idea por dónde va la ...","snippet": "Un mes después del derrame de la plataforma 'Deepwater Horizon' lo único  ...  vertido al Golfo de México, cuál es el impacto en la flora y la fauna marina,  ...  Para mí todo ese petróleo va acabar por desaparecer en el mar y  ...","ranking": 92,"size": 1.075268817,"rscore": 41.068886,"reputation": 3,"repu_normalizada": 1,"date": "20-05-2010","colour": 2,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.elmundo.es/america/2010/05/20/estados_unidos/1274316306.html"}, 
{ "id": "1142","repu": 66,"fecha": 71,"url": "http://noticias.masverdedigital.com/posicion-de-azul-ambientalistas-ante-el-derrame-de-petrolero-sin-precedentes-en-el-rio-guarapiche-de-maturin-estado-monagas-venezuela/","name": "Posición de Azul Ambientalistas ante el derrame de ...","snippet": "Después del derrame de petróleo acontecido en el Golfo de México, en  ...  mamíferos y demás especies de la flora y fauna, también deben ser  ...","ranking": 73,"size": 1.351351351,"rscore": 46.98398,"reputation": 1,"repu_normalizada": 0,"date": "11-02-2012","colour": 23,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/noticias.masverdedigital.com/posicion-de-azul-ambientalistas-ante-el-derrame-de-petrolero-sin-precedentes-en-el-rio-guarapiche-de-maturin-estado-monagas-venezuela/index.html"}, 
{ "id": "1143","repu": 40,"fecha": 43,"url": "http://m.cnnmexico.com/mundo/2010/07/04/mas-aves-acuaticas-peligran-por-el-derrame-de-petroleo-en-el-golfo","name": "Más aves acuáticas peligran por el derrame de petróleo en ...","snippet": "Muchas más aves y animales que anidan, se alimentan y se  ...  la cifra de aves muertas producto del derrame en el Golfo de México es menor a  ...","ranking": 41,"size": 2.380952381,"rscore": 41.74697,"reputation": 0,"repu_normalizada": 0,"date": "04-07-2010","colour": 4,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/m.cnnmexico.com/mundo/2010/07/04/mas-aves-acuaticas-peligran-por-el-derrame-de-petroleo-en-el-golfo.html"}, 
{ "id": "1144","repu": 67,"fecha": 13,"url": "http://www.actualidadambiental.pe/?p=5442","name": "Ensayan nueva técnica para controlar derrame de petróleo ...","snippet": "Sostuvo que una gran cantidad del petróleo derramado en el Golfo de México desde el punto donde la plataforma de BP se hundió no saldrá a  ...","ranking": 74,"size": 1.333333333,"rscore": 43.33736,"reputation": 1,"repu_normalizada": 0,"date": "06-05-2010","colour": 2,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.actualidadambiental.pe/index0a63.html"}, 
{ "id": "1145","repu": 41,"fecha": 63,"url": "http://www.americaeconomia.com/negocios-industrias/un-ano-del-desastre-petrolero-en-el-golfo-de-mexico-siguen-los-efectos-del-derra","name": "A un año del desastre petrolero en el Golfo de México ...","snippet": "Un año después, el petróleo del peor derrame en la historia de  ...  los pantanos, contaminó el océano y puso en peligro la flora y la fauna, sin  ...","ranking": 44,"size": 2.222222222,"rscore": 49.561424,"reputation": 0,"repu_normalizada": 0,"date": "20-04-2011","colour": 13,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.americaeconomia.com/negocios-industrias/un-ano-del-desastre-petrolero-en-el-golfo-de-mexico-siguen-los-efectos-del-derra.html"}, 
{ "id": "1146","repu": 42,"fecha": 55,"url": "http://www.oceanos.com.mx/html/golfopeligroext.html","name": "continua leyendo - Océanos - Expediciones y Buceo","snippet": "El Golfo de México en peligro de Extinción  ...  del país(2) por el derrame de petróleo acontecido el pasado 20 de abril en el Golfo de México (3).  ....  Así mismo, el Golfo de México es un área de gran diversidad de flora y fauna y una zona  ...","ranking": 39,"size": 2.5,"rscore": 44.22161,"reputation": 0,"repu_normalizada": 0,"date": "09-10-2010","colour": 7,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.oceanos.com.mx/html/golfopeligroext.html"}, 
{ "id": "1147","repu": 43,"fecha": 46,"url": "http://www.animanaturalis.org/n/11112","name": "¡Donando cabello ayudas a los animales del Golfo de México!","snippet": "¡Donando cabello ayudas a los animales del Golfo de México!  ...  El derrame de petróleo ocurrido el pasado 20 de Abril en el Golfo de México  ...","ranking": 32,"size": 3.03030303,"rscore": 40.93594,"reputation": 0,"repu_normalizada": 0,"date": "22-07-2010","colour": 4,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.animanaturalis.org/n/11112.html"}, 
{ "id": "1148","repu": 44,"fecha": 41,"url": "http://www.bioblogia.com/2010/07/derrames-de-petroleo-incrementarian-los-niveles-de-arsenico-en-los-oceanos/","name": "Los derrames de petróleo incrementarían los niveles de ...","snippet": "También puede matar a los animales como las aves que se alimentan  ...  amenaza tóxica luego del derrame de petroleo del Golfo de México.","ranking": 35,"size": 2.777777778,"rscore": 45.39434,"reputation": 0,"repu_normalizada": 0,"date": "03-07-2010","colour": 4,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.bioblogia.com/2010/07/derrames-de-petroleo-incrementarian-los-niveles-de-arsenico-en-los-oceanos/index.html"}, 
{ "id": "1149","repu": 45,"fecha": 62,"url": "http://worldcantwait-la.com/desastre-de-petroleo-en-el-gulfo.htm","name": "DESASTRE DEL PETR??LEO EN EL GOLFO Página 01","snippet": "Para entonces, ya se habían derramado casi cinco millones de barriles de petróleo de  ...  NUEVA ORLEANS, Estados Unidos - Los habitantes del Golfo de México  ...  Según ella, hay cada menos animales silvestres y, muchos días, el olor a  ...","ranking": 38,"size": 2.564102564,"rscore": 41.032265,"reputation": 0,"repu_normalizada": 0,"date": "19-04-2011","colour": 13,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/worldcantwait-la.com/desastre-de-petroleo-en-el-gulfo.html"}, 
{ "id": "1150","repu": 46,"fecha": 35,"url": "http://eju.tv/2010/06/cmo-se-alivian-los-efectos-del-derrame-de-petrleo-en-la-flora-y-fauna-del-golfo-de-mxico/","name": "Cómo aliviar los efectos del derrame de petróleo en la flora ...","snippet": "Entrevista al director de la fundación World Wildlife, Roberto Troya.  ...  efectos del derrame de petróleo en la flora y fauna del Golfo de México?","ranking": 36,"size": 2.702702703,"rscore": 40.361435,"reputation": 0,"repu_normalizada": 0,"date": "07-06-2010","colour": 3,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/eju.tv/2010/06/cmo-se-alivian-los-efectos-del-derrame-de-petrleo-en-la-flora-y-fauna-del-golfo-de-mxico/index.html"}, 
{ "id": "1151","repu": 47,"fecha": 81,"url": "http://www.emol.com/noticias/internacional/2014/02/01/642719/detectan-delfines-enfermos-en-el-golfo-de-mexico.html","name": "Detectan delfines enfermos en el Golfo de México - Emol.com","snippet": "La empresa responsable del derrame de 2010 afirmó que el estudio  ...  hallados en el Golfo de México, que en 2010 sufrió un derrame de petróleo.  ...  'Nunca he visto un nivel tan alto de animales tan enfermos', señaló la  ...","ranking": 15,"size": 6.25,"rscore": 55.87703,"reputation": 0,"repu_normalizada": 0,"date": "01-02-2014","colour": 47,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.emol.com/noticias/internacional/2014/02/01/642719/detectan-delfines-enfermos-en-el-golfo-de-mexico.html"}, 
{ "id": "1152","repu": 48,"fecha": 53,"url": "http://www.pucp.edu.pe/climadecambios/index.php?tmpl=articulo&id=868","name": "El derrame de petróleo en el Golfo de México :: PUCP ...","snippet": "La mancha de petróleo que se originó en el golfo de México por la  ...  y costero, y un derrame del mismo afecta de manera grave al ecosistema, daño  ...  hagan algo por todos esos animales que no les importe el dinero... asi  ...","ranking": 31,"size": 3.125,"rscore": 56.94012,"reputation": 0,"repu_normalizada": 0,"date": "07-09-2010","colour": 6,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.pucp.edu.pe/climadecambios/index7606.html"}, 
{ "id": "1153","repu": 49,"fecha": 28,"url": "http://mardechile.cl/wordpress/?p=2844","name": "Aves, delfines y moluscos comienzan a morir intoxicados ...","snippet": "Hoy, la fauna y flora está comenzando a resentir la extensa  ...  cree que los esfuerzos por detener el derrame de petróleo no tendrán éxito y tan sólo  ...  sobre los efectos del derrame en la vida marina del Golfo de México, para  ...","ranking": 29,"size": 3.333333333,"rscore": 55.969406,"reputation": 0,"repu_normalizada": 0,"date": "25-05-2010","colour": 2,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/mardechile.cl/wordpress/index77cc.html"}, 
{ "id": "1154","repu": 50,"fecha": 8,"url": "http://www.dw.com/es/ecocidio-petrolero-en-el-golfo-de-m%C3%A9xico-c%C3%B3mo-detenerlo/a-5530556","name": "Ecocidio petrolero en el Golfo de México: ¿Cómo detenerlo ...","snippet": "La fauna y flora silvestres, así como la piscicultura están amenazadas. El actual derrame de crudo en el Golfo de México puede convertirse en  ...","ranking": 27,"size": 3.571428571,"rscore": 56.25614,"reputation": 0,"repu_normalizada": 0,"date": "02-05-2010","colour": 2,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.dw.com/es/ecocidio-petrolero-en-el-golfo-de-m%C3%A9xico-c%C3%B3mo-detenerlo/a-5530556.html"}, 
{ "id": "1155","repu": 51,"fecha": 48,"url": "http://natura-lee.blogspot.com/2010/07/donando-cabello-ayudas-los-animales-del.html","name": "Donando cabello ayudas a los animales del Golfo de México!","snippet": "El derrame de petróleo ocurrido el pasado 20 de Abril en el Golfo de México ha desatado una de las catástrofes ambientales más graves a  ...","ranking": 20,"size": 4.761904762,"rscore": 52.54042,"reputation": 0,"repu_normalizada": 0,"date": "31-07-2010","colour": 4,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/natura-lee.blogspot.cl/2010/07/donando-cabello-ayudas-los-animales-del.html"}, 
{ "id": "1156","repu": 52,"fecha": 4,"url": "http://www.scielo.org.mx/scielo.php?script=sci_arttext&pid=S0188-49992007000300004","name": "Revista internacional de contaminación ambiental ...","snippet": "Uno de los impactos más negativos lo genera el derrame de petróleo con su  ...  principalmente por vegetación arbórea, la fauna y la flora interrelacionadas, así  ....  lo que representa un 14 % de los manglares del Golfo de México (Moreno et al.","ranking": 23,"size": 4.166666667,"rscore": 54.72293,"reputation": 0,"repu_normalizada": 0,"date": "08-08-2007","colour": 0,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.scielo.org.mx/scielo7b07.html"}, 
{ "id": "1157","repu": 53,"fecha": 70,"url": "http://elclima-enelmundo.blogspot.com/2012/01/mexico-derrame-de-petroleo-provoca.html","name": "México, derrame de petróleo provoca graves daños en flora ...","snippet": "México, derrame de petróleo provoca graves daños en flora y fauna de  ...  río Coatzacoalcos que está desembocando hacia el Golfo de México,  ...","ranking": 16,"size": 5.882352941,"rscore": 51.369415,"reputation": 0,"repu_normalizada": 0,"date": "04-01-2012","colour": 22,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/elclima-enelmundo.blogspot.cl/2012/01/mexico-derrame-de-petroleo-provoca.html"}, 
{ "id": "1158","repu": 54,"fecha": 59,"url": "http://www.buenastareas.com/ensayos/Derrame-De-Petroleo-En-El-Golfo/1523160.html","name": "Derrame de petroleo en el golfo de mexico - Ensayos ...","snippet": "El derrame de crudo en el Golfo de México traerá graves consecuencias a la fauna y flora pertenecientes al área, ya que afecta el aire y el  ...","ranking": 18,"size": 5.263157895,"rscore": 53.790665,"reputation": 0,"repu_normalizada": 0,"date": "09-02-2011","colour": 11,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.buenastareas.com/ensayos/Derrame-De-Petroleo-En-El-Golfo/1523160.html"}, 
{ "id": "1159","repu": 55,"fecha": 80,"url": "http://ar.selecciones.com/contenido/a1044_el-derrame-de-petroleo-en-el-golfo-de-mexico","name": "El derrame de petroleo en el Golfo de Mexico - Selecciones","snippet": "El derrame de petroleo en el Golfo de Mexico se hace casi incontenible.  ...  Conoce de la contaminación en el agua, la que sufren los animales y la que se  ...","ranking": 25,"size": 3.846153846,"rscore": 59.4415,"reputation": 0,"repu_normalizada": 0,"date": "01-12-2013","colour": 65,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/ar.selecciones.com/contenido/a1044_el-derrame-de-petroleo-en-el-golfo-de-mexico.html"}, 
{ "id": "1160","repu": 56,"fecha": 20,"url": "http://revcom.us/a/201/oil_spill-es.html","name": "El desastre del derrame de petróleo??? y un sistema que NO ...","snippet": "El desastre del derrame de petróleo??? y un sistema que NO merece ser el  ...  Un enorme derrame de petróleo está ocurriendo en el Golfo de México ??? un  ....  daño que este derrame está haciendo a todo tipo de fauna y flora  ...","ranking": 21,"size": 4.545454545,"rscore": 57.24169,"reputation": 0,"repu_normalizada": 0,"date": "16-05-2010","colour": 2,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/revcom.us/a/201/oil_spill-es.html"}, 
{ "id": "1161","repu": 57,"fecha": 33,"url": "https://sembradoresdelsaber.wordpress.com/derrame-de-petroleo-en-el-golfo-de-mexico/","name": "DERRAME DE PETR??LEO EN EL GOLFO DE M??XICO ...","snippet": "Se trata de el derrame de Petróleo en el Golfo de México, un acontecimiento ???  ...  ya que algunos estan en peligro de extinción tanto como flora y fauna.","ranking": 1,"size": 50,"rscore": 67.32223,"reputation": 0,"repu_normalizada": 0,"date": "28-05-2010","colour": 2,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/sembradoresdelsaber.wordpress.com/derrame-de-petroleo-en-el-golfo-de-mexico/index.html"}, 
{ "id": "1162","repu": 58,"fecha": 58,"url": "http://www.ocio.net/estilo-de-vida/ecologismo/derrame-de-petroleo-en-el-golfo-de-mexico/","name": "Derrame de petróleo en el Golfo de México - Ocio","snippet": "Derrame de petróleo en el Golfo de México, crecen día a día los daños causados por la explosión de una plataforma estadounidense y su posterior ...","ranking": 13,"size": 7.142857143,"rscore": 65.30197,"reputation": 0,"repu_normalizada": 0,"date": "01-12-2010","colour": 9,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.ocio.net/estilo-de-vida/ecologismo/derrame-de-petroleo-en-el-golfo-de-mexico/index.html"}, 
{ "id": "1163","repu": 59,"fecha": 95,"url": "http://www.unotv.com/noticias/internacional/detalle/alertan-por-secuelas-de-derrame-de-petroleo-en-golfo-de-mexico-263872/","name": "Alertan por secuelas de derrame de petróleo en Golfo de ...","snippet": "Alertan por secuelas de derrame de petróleo en Golfo de México. AP México 18-04-2015 10:  ...  Animales resultaron con diversas afectaciones.","ranking": 24,"size": 4,"rscore": 66.990616,"reputation": 0,"repu_normalizada": 0,"date": "18-04-2015","colour": 61,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/blogs.funiber.org/medio-ambiente/2010/05/27/especies-en-peligro-de-extincion-afectadas-por-derrame-de-petroleo.html"}, 
{ "id": "1164","repu": 60,"fecha": 56,"url": "http://sosoceanos.blogspot.com/2010/11/numero-estimado-de-animales-muertos-en.html","name": "número estimado de animales muertos en el derrame de ...","snippet": "La web oficial del gobierno federal ha publicado su último informe sobre el derrame de petróleo en el golfo de México. En el informe han  ...","ranking": 19,"size": 5,"rscore": 66.87502,"reputation": 0,"repu_normalizada": 0,"date": "04-11-2010","colour": 8,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/sosoceanos.blogspot.cl/2010/11/numero-estimado-de-animales-muertos-en.html"}, 
{ "id": "1165","repu": 61,"fecha": 38,"url": "http://www.corporacionraya.org/index.php/18-actualidad/1604-los-animales-mas-afectados-por-el-derrame-de-petroleo-del-golfo-de-mexico","name": "Los animales más afectados por el derrame de petróleo del ...","snippet": "Cuales son los animales más amenazados y afectados por el derrame de petroleo en el golfo de Mexico?. La verdad es que todo ser vivo expuesto a los ...","ranking": 2,"size": 33.33333333,"rscore": 64.67116,"reputation": 0,"repu_normalizada": 0,"date": "20-06-2010","colour": 3,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.corporacionraya.org/index.php/18-actualidad/1604-los-animales-mas-afectados-por-el-derrame-de-petroleo-del-golfo-de-mexico.html"}, 
{ "id": "1166","repu": 62,"fecha": 94,"url": "http://sipse.com/mundo/golfo-de-mexico-con-signos-alentadores-de-recuperacion-147076.html","name": "Golfo de México se recupera del mayor derrame de petróleo ...","snippet": "El Golfo de México se recupera de histórico derrame de crudo  ...  animales marinos que viven en las profundidades del Golfo de México.","ranking": 14,"size": 6.666666667,"rscore": 63.29037,"reputation": 0,"repu_normalizada": 0,"date": "16-04-2015","colour": 61,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/sipse.com/mundo/golfo-de-mexico-con-signos-alentadores-de-recuperacion-147076.html"}, 
{ "id": "1167","repu": 68,"fecha": 69,"url": "http://ibugueno.bligoo.cl/content/view/841006/Derrame-petrolero-del-Golfo-de-Mexico-causa-incalculable-impacto-ambiental.html","name": "Derrame petrolero del Golfo de México causa incalculable ...","snippet": "Derrame petrolero del Golfo de México causa incalculable impacto ambiental  ...  la vida marina y costera en la zona, tanto de flora y fauna, por varios años.","ranking": 53,"size": 1.851851852,"rscore": 62.28755,"reputation": 1,"repu_normalizada": 0,"date": "01-12-2011","colour": 65,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/ibugueno.bligoo.cl/content/view/841006/Derrame-petrolero-del-Golfo-de-Mexico-causa-incalculable-impacto-ambiental.html"}, 
{ "id": "1168","repu": 63,"fecha": 87,"url": "http://wiki.salahumanitaria.co/index.php/Derrame_de_petr%C3%B3leo","name": "Derrame de petróleo - Wiki.SalaHumanitaria.co","snippet": "2.1 Derrames de petróleo con gran incidencia en la fauna y la flora  ...  consumen transmiten el envenenamiento petrolero de un animal a otro  ...","ranking": 8,"size": 11.11111111,"rscore": 66.57046,"reputation": 0,"repu_normalizada": 0,"date": "19-06-2014","colour": 51,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/wiki.salahumanitaria.co/index.php/Derrame_de_petr%C3%B3leo.html"}, 
{ "id": "1169","repu": 64,"fecha": 98,"url": "https://es.wikipedia.org/wiki/Deepwater_Horizon","name": "Deepwater Horizon - Wikipedia, la enciclopedia libre","snippet": "Destino, Hundida a 1500 m en el Golfo de México el 22 de abril de 2010  ...  2 Historia","ranking": 6,"size": 14.28571429,"rscore": 65.74962,"reputation": 0,"repu_normalizada": 0,"date": "29-11-2015","colour": 65,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/es.wikipedia.org/wiki/Deepwater_Horizon.html"}, 
{ "id": "1170","repu": 73,"fecha": 82,"url": "http://www.lr21.com.uy/mundo/1159332-derrames-de-petroleo-intoxican-atunes-y-cardumenes-mueren-de-paro-cardiaco","name": "Derrames de petróleo intoxican atunes y cardúmenes ...","snippet": "Los técnicos descubrieron que el petróleo crudo es capaz de interrumpir una  ...  tanto en estos animales como en mamíferos, inclusive los humanos.  ...  la investigación del derrame petrolero en el Golfo de México hasta fecha  ...","ranking": 65,"size": 1.515151515,"rscore": 69.944,"reputation": 2,"repu_normalizada": 0,"date": "15-02-2014","colour": 47,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.lr21.com.uy/mundo/1159332-derrames-de-petroleo-intoxican-atunes-y-cardumenes-mueren-de-paro-cardiaco.html"}, 
{ "id": "1171","repu": 74,"fecha": 93,"url": "http://erenovable.com/derrame-de-petroleo-en-golfo-de-mexico-marea-negra-en-luisiana/","name": "Recordamos | Derrame de petróleo en Golfo de México ...","snippet": "El derrame de petróleo en el Golfo de México de 2010 fue uno de los peores de la historia suscitado verdadera preocupación en Estados ...","ranking": 62,"size": 1.587301587,"rscore": 72.52025,"reputation": 2,"repu_normalizada": 0,"date": "14-01-2015","colour": 58,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/erenovable.com/derrame-de-petroleo-en-golfo-de-mexico-marea-negra-en-luisiana/index.html"}, 
{ "id": "1172","repu": 69,"fecha": 37,"url": "http://www.brookings.edu/es/research/testimony/2010/06/09-oil-spill-greenstone","name": "Responsabilidades económicas por los derrames de ...","snippet": "Tras el derrame de petróleo de la plataforma Deepwater Horizon,  ...  para disponer de hábitats saludables para la fauna y la flora, para  ....  El Golfo de México representa sólo el 2,3% de la producción de petróleo mundial.","ranking": 26,"size": 3.703703704,"rscore": 70.46785,"reputation": 1,"repu_normalizada": 0,"date": "09-06-2010","colour": 3,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.brookings.edu/es/research/testimony/2010/06/09-oil-spill-greenstone.html"}, 
{ "id": "1173","repu": 82,"fecha": 7,"url": "http://universitam.com/academicos/?p=1570","name": "tejidos de bioingenieria una alternativa a la ... - Universitam","snippet": "UU. sin pruebas en animales ??? una situación que tiene graves implicaciones  ...  GOLFO DE MEXICO: DESASTRE ECOLOGICO POR DERRAME DE PETROLEO  ...  DEL DERRAME DE PETROLEO EN EL GOLFO DE MEXICO.","ranking": 75,"size": 1.315789474,"rscore": 71.19829,"reputation": 4,"repu_normalizada": 1,"date": "01-05-2010","colour": 2,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/universitam.com/academicos/index2bee.html"}, 
{ "id": "1174","repu": 70,"fecha": 77,"url": "http://lasaludfamiliar.com/contenido/articulos-de-salud-1767.htm","name": "Los impactos negativos del derrame de petróleo de BP en ...","snippet": "Los impactos negativos del derrame de petróleo de BP en los Animales, Los  ...  El derrame de petróleo de BP ocurrido en el Golfo de México el 20 de abril de  ...","ranking": 12,"size": 7.692307692,"rscore": 70.65385,"reputation": 1,"repu_normalizada": 0,"date": "09-05-2013","colour": 38,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/lasaludfamiliar.com/contenido/articulos-de-salud-1767.html"}, 
{ "id": "1175","repu": 75,"fecha": 10,"url": "http://eleconomista.com.mx/internacional/2010/05/05/cronologia-derrame-crudo-golfo","name": "Cronología del derrame de crudo en el Golfo | El Economista","snippet": "...  cronología del derrame y su impacto económico, así como en la flora y la fauna  ...  Una explosión en una plataforma de perforación petrolera dejó 11  ...  fuga submarina esparce petróleo por todo el norte del Golfo de México  ...","ranking": 40,"size": 2.43902439,"rscore": 78.24351,"reputation": 2,"repu_normalizada": 0,"date": "05-05-2010","colour": 2,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/eleconomista.com.mx/internacional/2010/05/05/cronologia-derrame-crudo-golfo.html"}, 
{ "id": "1176","repu": 86,"fecha": 91,"url": "http://www.ultimasnoticias.com.ve/noticias/actualidad/regiones/fotos--pdvsa-confirma-derrame-de-petroleo-en-la-ba.aspx","name": "Fotos| Pdvsa confirma derrame de petróleo en la bahía de ...","snippet": "Derrame petrolero en Amuay (Créditos: @VanessaFlores_1)  ...  podrán revivir las especies de fauna y flora marina que padecieron el derrame.  ...  por pequeña que sea, y recuerdo la fuga en el golfo de Mexico, y creo que BP  ...","ranking": 61,"size": 1.612903226,"rscore": 70.49385,"reputation": 5,"repu_normalizada": 1,"date": "27-10-2014","colour": 65,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.ultimasnoticias.com.ve/noticias/actualidad/regiones/fotos--pdvsa-confirma-derrame-de-petroleo-en-la-ba.html"}, 
{ "id": "1177","repu": 76,"fecha": 96,"url": "http://hipertextual.com/2015/04/historia-de-los-derrames-de-petroleo","name": "Historia de los derrames de petróleo - Hipertextual","snippet": "Los derrames de petróleo desde barcos y estaciones de extracción de  ...  de las marismas del Misisipi, hogar de 400 especies animales protegidas, de  ...  También en el Golfo de México, el pozo exploratorio de petróleo Ixtoc I  ...","ranking": 33,"size": 2.941176471,"rscore": 76.840004,"reputation": 2,"repu_normalizada": 0,"date": "22-04-2015","colour": 61,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/hipertextual.com/2015/04/historia-de-los-derrames-de-petroleo.html"}, 
{ "id": "1178","repu": 77,"fecha": 90,"url": "http://www.ecoosfera.com/tag/animales-afectados-derrame-petroleo-golfo-mexico/","name": "animales afectados derrame petroleo golfo mexico | Ecoosfera","snippet": "De acuerdo con Greenpeace, tanto la contaminación como el cambio climático han disminuido la disponibilidad del agua en México per cápita de 11 mil 500m3 ...","ranking": 0,"size": 100,"rscore": 74.463936,"reputation": 2,"repu_normalizada": 0,"date": "15-09-2014","colour": 65,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.ecoosfera.com/tag/animales-afectados-derrame-petroleo-golfo-mexico/index.html"}, 
{ "id": "1179","repu": 78,"fecha": 9,"url": "http://www.greenpeace.org/mexico/es/Noticias/2010/Mayo/biodiversidad-del-golfo-de-mex/","name": "Biodiversidad del Golfo de México en riesgo por derrame ...","snippet": "Desafortunadamente, el Golfo de México no es ajeno a los derrames de petróleo. Después de los huracanes Katrina y Rita, en 2005, varias  ...","ranking": 10,"size": 9.090909091,"rscore": 70.00667,"reputation": 2,"repu_normalizada": 0,"date": "03-05-2010","colour": 2,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.greenpeace.org/mexico/es/Noticias/2010/Mayo/biodiversidad-del-golfo-de-mex/index.html"}, 
{ "id": "1180","repu": 79,"fecha": 50,"url": "http://www.taringa.net/posts/info/6492216/Derrame-de-petroleo-en-el-golfo-de-Mexico.html","name": "Derrame de petroleo en el golfo de Mexico - Taringa!","snippet": "Derrame de petróleo en el Golfo de México:crecen diadía los daños  ...  y animales mamíferos, siguen sufriendo la amenaza del petróleo.","ranking": 9,"size": 10,"rscore": 74.352486,"reputation": 2,"repu_normalizada": 0,"date": "07-08-2010","colour": 5,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.taringa.net/posts/info/6492216/Derrame-de-petroleo-en-el-golfo-de-Mexico.html"}, 
{ "id": "1181","repu": 91,"fecha": 86,"url": "http://www.consumer.es/web/es/medio_ambiente/naturaleza/2014/05/29/219972.php","name": "Los doce peores desastres ecológicos del mundo - Consumer","snippet": "Derrame de crudo en el golfo de México  ...  Se considera el mayor derrame de petróleo accidental marino en la historia de  ...  proliferación de algas que asfixian la flora y la fauna o reducción de la cantidad de sus aguas.","ranking": 80,"size": 1.234567901,"rscore": 86.62468,"reputation": 10,"repu_normalizada": 2,"date": "29-05-2014","colour": 50,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.consumer.es/web/es/medio_ambiente/naturaleza/2014/05/29/219972.html"}, 
{ "id": "1182","repu": 83,"fecha": 19,"url": "http://www.madrimasd.org/blogs/ciencia_marina/2010/05/15/131494","name": "Vertido de petróleo en el Golfo de México. Incontrolado.","snippet": "Se calcula que en la actualidad hay flotando en el golfo de México unas 31.000  ...  La propia petrolera ha admitido que el derrame está fuera de control y es  ....  Los pobres animales atrapados,el medio ambiente en peligro???","ranking": 45,"size": 2.173913043,"rscore": 82.46376,"reputation": 4,"repu_normalizada": 1,"date": "15-05-2010","colour": 2,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.madrimasd.org/blogs/ciencia_marina/2010/05/15/131494.html"}, 
{ "id": "1183","repu": 71,"fecha": 49,"url": "http://www.carbonoybosques.org/ultimas_noticias/el_derrame_de_petroleo_en_el_golfo_de_mexico_cual_es_su_impacto_sobre_la_biodiversidad.html","name": "Derrame de petróleo en el Golfo de México ¿cuál es su ...","snippet": "Derrame de petróleo en el Golfo de México ¿cuál es su impacto sobre la  ...  algas y las praderas marinas, de las cuales dependen miles de especies animales.","ranking": 4,"size": 20,"rscore": 87.487,"reputation": 1,"repu_normalizada": 0,"date": "06-08-2010","colour": 5,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.carbonoybosques.org/ultimas_noticias/el_derrame_de_petroleo_en_el_golfo_de_mexico_cual_es_su_impacto_sobre_la_biodiversidad.html"}, 
{ "id": "1184","repu": 81,"fecha": 32,"url": "http://blogs.funiber.org/medio-ambiente/2010/05/27/especies-en-peligro-de-extincion-afectadas-por-derrame-de-petroleo","name": "Especies en peligro de extinción afectadas por derrame de ...","snippet": "El derrame de petróleo originado por la transnacional British Petroleum  ...  La comunidad está preocupada por animales como los pelícanos o los  ...  que el 97% de las especies marinas del golfo de México dependen de los  ...","ranking": 22,"size": 4.347826087,"rscore": 84.72769,"reputation": 3,"repu_normalizada": 1,"date": "27-05-2010","colour": 2,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/blogs.funiber.org/medio-ambiente/2010/05/27/especies-en-peligro-de-extincion-afectadas-por-derrame-de-petroleo.html"}, 
{ "id": "1185","repu": 98,"fecha": 36,"url": "http://www.universitario.com.br/noticias/n.php?i=10095","name": "Consequências do vazamento de petróleo no Golfo do México","snippet": "Desde então, o óleo vem prejudicando a fauna marinha, o turismo e a pesca  ...  o vazamento falharam e o derrame deve continuar por mais um mês.  ...  O vazamento de petróleo cru e de gás no Golfo do México causou, além  ...","ranking": 96,"size": 1.030927835,"rscore": 80.82231,"reputation": 32,"repu_normalizada": 5,"date": "07-06-2010","colour": 3,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.universitario.com.br/noticias/n8667.html"}, 
{ "id": "1186","repu": 88,"fecha": 73,"url": "http://www.guia-urbana.com/contaminacion/contaminacion-por-petroleo.php","name": "Contaminación por petróleo - Guia urbana","snippet": "El petróleo es altamente contaminante, y su derrame en las aguas  ...  En 1979 en el Golfo de México, ocurrió el mayor escape de petróleo al mar, en el pozo  ...  y las branquias de los animales acuáticos, provocándoles la muerte por asfixia.","ranking": 52,"size": 1.886792453,"rscore": 84.272064,"reputation": 6,"repu_normalizada": 1,"date": "31-05-2012","colour": 26,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.guia-urbana.com/contaminacion/contaminacion-por-petroleo.html"}, 
{ "id": "1187","repu": 87,"fecha": 79,"url": "http://www.elmundo.es/elmundo/2013/09/25/natura/1380102362.html","name": "La huella del desastre petrolero en el Golfo de México ...","snippet": "La explosión que causó el vertido en el Golfo de México en 2010.  ...  El derrame de petróleo del pozo Macondo de British Petroleum (BP) tuvo su  ...  pequeños animales marinos e invertebrados de agua dulce, dijo en el sitio a  ...","ranking": 37,"size": 2.631578947,"rscore": 83.844505,"reputation": 5,"repu_normalizada": 1,"date": "25-09-2013","colour": 65,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.elmundo.es/elmundo/2013/09/25/natura/1380102362.html"}, 
{ "id": "1188","repu": 84,"fecha": 29,"url": "http://www.madrimasd.org/blogs/ciencia_marina/2010/05/25/131506","name": "Vertido en el Golfo de México: ¿la historia interminable?","snippet": "Pero lo que está sucediendo en el desastre del Golfo de México es  ....  al petróleo derramado a la cadena alimenticia de la flora y la fauna  ...","ranking": 11,"size": 8.333333333,"rscore": 82.542854,"reputation": 4,"repu_normalizada": 1,"date": "25-05-2010","colour": 2,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.madrimasd.org/blogs/ciencia_marina/2010/05/25/131506.html"}, 
{ "id": "1189","repu": 85,"fecha": 61,"url": "http://www.taringa.net/posts/apuntes-y-monografias/9643249/Monografia-Derrame-de-petroleo-del-Golfo-de-Mexico-propio.html","name": "Monografía Derrame de petróleo del Golfo de Mexico (propio","snippet": "Decidimos elegir el derrame de petróleo en el golfo de México por el  ....  Estos animales huyen de la marea negra que avanza en el sur de  ...","ranking": 7,"size": 12.5,"rscore": 87.85073,"reputation": 4,"repu_normalizada": 1,"date": "21-03-2011","colour": 12,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.taringa.net/post/apuntes-y-monografias/9643249/Monografia-Derrame-de-petroleo-del-Golfo-de-Mexico-propio.html"}, 
{ "id": "1190","repu": 93,"fecha": 88,"url": "http://www.humanecapture.com/intl/spanish.html","name": "Equipo para la captura de animales | Cañón lanza-redes ...","snippet": "Ofrecemos equipos para la captura de animales, armas para el control de animales y  ...  como ocurrió durante el derrame de petróleo en el Golfo de México.","ranking": 55,"size": 1.785714286,"rscore": 84.68752,"reputation": 13,"repu_normalizada": 2,"date": "28-07-2014","colour": 52,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.humanecapture.com/intl/spanish.html"}, 
{ "id": "1191","repu": 89,"fecha": 76,"url": "http://www.ecologiaverde.com/los-animales-siguen-intoxicandose-con-petroleo-en-el-golfo-de-mexico/","name": "Los animales siguen intoxicándose con petróleo en el golfo ...","snippet": "¿Cómo se encuentra el golfo de México después del vertido de petróleo causado por la petrolera BP? Los científicos advierten que, a pesar de ...","ranking": 17,"size": 5.555555556,"rscore": 93.080956,"reputation": 7,"repu_normalizada": 1,"date": "18-04-2013","colour": 37,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.ecologiaverde.com/los-animales-siguen-intoxicandose-con-petroleo-en-el-golfo-de-mexico/index.html"}, 
{ "id": "1192","repu": 90,"fecha": 44,"url": "http://portal.educ.ar/debates/eid/ciencia/cronica-de-un-desastre-anuncia.php","name": "Crónica de un desastre anunciado: derrame de petróleo en ...","snippet": "El desastre ambiental que está ocurriendo en el Golfo de México  ...  ambiental y sus consecuencias catastróficas para la fauna, la flora y la vida  ...","ranking": 3,"size": 25,"rscore": 98.88975,"reputation": 7,"repu_normalizada": 1,"date": "05-07-2010","colour": 4,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/portal.educ.ar/debates/eid/ciencia/cronica-de-un-desastre-anuncia.html"}, 
{ "id": "1193","repu": 99,"fecha": 97,"url": "http://www.lavanguardia.com/natural/20150521/54431367094/deepwater-horizon-vertido-petroleo-2010-sigue-matando-delfines.html","name": "El petróleo vertido en 2010 en Golfo de México aún mata ...","snippet": "El petróleo vertido en 2010 en el Golfo de México sigue matando delfines  ...  en el norte del Golfo de México después del derrame de petróleo de la  ...  'Los animales con insuficiencia suprarrenal son menos capaces de hacer  ...","ranking": 83,"size": 1.19047619,"rscore": 94.21684,"reputation": 38,"repu_normalizada": 6,"date": "21-05-2015","colour": 62,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.lavanguardia.com/natural/20150521/54431367094/deepwater-horizon-vertido-petroleo-2010-sigue-matando-delfines.html"}, 
{ "id": "1194","repu": 92,"fecha": 34,"url": "http://www.20minutos.es/noticia/728547/0/vertidos/petroleo/claves/","name": "La lista más negra: Más de 130 desastres por vertidos de ...","snippet": "La catástrofe ecológica en el Golfo de México se suma a una larga serie de  ...  La lista más negra: Más de 130 desastres por vertidos de petróleo desde 1960  ...  sino también uno de los derrames de crudo más graves de la historia,  ...  en el Delta del Misisipi, donde viven 400 especies animales protegidas.","ranking": 30,"size": 3.225806452,"rscore": 99.6068,"reputation": 10,"repu_normalizada": 2,"date": "06-06-2010","colour": 3,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.20minutos.es/noticia/728547/0/vertidos/petroleo/claves/index.html"}, 
{ "id": "1195","repu": 97,"fecha": 89,"url": "http://www.quo.es/ciencia/petroleo-en-el-paraiso/y-que-dicen-las-especies-marinas-de-las-prospecciones-petroliferas","name": "¿Y qué dicen las especies marinas de las prospecciones ...","snippet": "Cómo limpian el petróleo - El vertido del Golfo de México  ...  Tags: animales, canarias, cetáceos, derrame, petróleo, sondeos sísmicos y  ...","ranking": 63,"size": 1.5625,"rscore": 90.6583,"reputation": 27,"repu_normalizada": 5,"date": "11-08-2014","colour": 65,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/www.quo.es/ciencia/petroleo-en-el-paraiso/y-que-dicen-las-especies-marinas-de-las-prospecciones-petroliferas.html"}, 
{ "id": "1196","repu": 94,"fecha": 15,"url": "http://tuverde.com/2010/05/se-teme-desastre-ambiental-por-derrame-de-petroleo-en-el-golfo-de-mexico/","name": "derrame de petróleo en el Golfo de México - TuVerde.com","snippet": "Desastre ambiental por derrame de petróleo en el Golfo de México  ...  puesto que estan muriendo muchos animales por causa de este mismo.","ranking": 28,"size": 3.448275862,"rscore": 97.67472,"reputation": 15,"repu_normalizada": 3,"date": "07-05-2010","colour": 2,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/tuverde.com/2010/05/se-teme-desastre-ambiental-por-derrame-de-petroleo-en-el-golfo-de-mexico/index.html"}, 
{ "id": "1197","repu": 96,"fecha": 17,"url": "http://espiritualidadypolitica.blogspot.com/2010/05/atencion-al-derrame-de-petroleo-del.html","name": "Atención al derrame de petróleo del Golfo de México","snippet": "Atención al derrame de petróleo del Golfo de México  ...  de motor para convertir 250.000 galones de agua en un tóxico para la fauna y la flora.","ranking": 34,"size": 2.857142857,"rscore": 95.03542,"reputation": 21,"repu_normalizada": 4,"date": "11-05-2010","colour": 2,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/espiritualidadypolitica.blogspot.cl/2010/05/atencion-al-derrame-de-petroleo-del.html"}, 
{ "id": "1198","repu": 95,"fecha": 99,"url": "https://es.wikipedia.org/wiki/Derrame_de_petr%C3%B3leo","name": "Derrame de petróleo - Wikipedia, la enciclopedia libre","snippet": "Tareas de limpieza del derrame de petróleo provocado por el buque 'Prestige'.  ...  el envenenamiento petrolero de un animal a otro por la cadena alimenticia,  ...  provocando un derrame de petróleo incontrolado en el golfo de México que  ...","ranking": 5,"size": 16.66666667,"rscore": 97.65315,"reputation": 20,"repu_normalizada": 3,"date": "29-11-2015","colour": 65,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/es.wikipedia.org/wiki/Derrame_de_petr%C3%B3leo.html"}, 
{ "id": "1199","repu": 100,"fecha": 54,"url": "http://revistaescola.abril.com.br/ciencias/fundamentos/impactos-vazamento-petroleo-como-golfo-mexico-pode-causar-fauna-flora-regiao-594556.shtml","name": "Que impactos um vazamento de petróleo, como o do golfo ...","snippet": "Meio ambiente. Que impactos um vazamento de petróleo, como o do golfo do México, pode causar à fauna e à flora de uma região? Bruna Nicolielo ...","ranking": 54,"size": 1.818181818,"rscore": 97.78068,"reputation": 59,"repu_normalizada": 10,"date": "09-09-2010","colour": 6,"url_local": "http://localhost/ProyectoTesis/DataSet/Grupo1/revistaescola.abril.com.br/ciencias/fundamentos/impactos-vazamento-petroleo-como-golfo-mexico-pode-causar-fauna-flora-regiao-594556.html"}
]
};
};
function getData2() {
